...
- [FHIR: simple - 100% sykmelding](./multi-mode/form-submit.spec.ts#L28)
- [FHIR: simple - gradert sykmelding](./multi-mode/form-submit.spec.ts#L86)
- [FHIR: optional - multiple bidiagnoser](./multi-mode/form-submit.spec.ts#L139)
- [FHIR: optional - multiple perioder back to back](./multi-mode/form-submit.spec.ts#L201)
- [FHIR: optional - 'tilbakedatering' is asked and required when fom is 5 days in the past](./multi-mode/form-submit.spec.ts#L259)
- [FHIR: optional - "tilbakedatering" and "Annen årsak" input field is required and part of payload when checked](./multi-mode/form-submit.spec.ts#L360)
- [FHIR: optional - "har flere arbeidsforhold" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L403)
- [FHIR: optional - when 100%, "arbeidsrelaterte og medisinske årsaker" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L466)
- [FHIR: summary - "skal skjermes" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L531)
- [Standalone: simple - 100% sykmelding](./multi-mode/form-submit.spec.ts#L28)
- [Standalone: simple - gradert sykmelding](./multi-mode/form-submit.spec.ts#L86)
- [Standalone: optional - multiple bidiagnoser](./multi-mode/form-submit.spec.ts#L139)
- [Standalone: optional - multiple perioder back to back](./multi-mode/form-submit.spec.ts#L201)
- [Standalone: optional - 'tilbakedatering' is asked and required when fom is 5 days in the past](./multi-mode/form-submit.spec.ts#L259)
- [Standalone: optional - "tilbakedatering" and "Annen årsak" input field is required and part of payload when checked](./multi-mode/form-submit.spec.ts#L360)
- [Standalone: optional - "har flere arbeidsforhold" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L403)
- [Standalone: optional - when 100%, "arbeidsrelaterte og medisinske årsaker" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L466)
- [Standalone: summary - "skal skjermes" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L531)
    ## [FHIR: rule outcomes](./multi-mode/form-submit.spec.ts)
    - [FHIR: invalid but functionally expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L597)
    - [FHIR: manuell behandling and expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L647)
    - [FHIR: invalid but unexpected: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L697)
    - [FHIR: person does not exist in PDL: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L704)
    ## [Standalone: rule outcomes](./multi-mode/form-submit.spec.ts)
    - [Standalone: invalid but functionally expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L597)
    - [Standalone: manuell behandling and expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L647)
    - [Standalone: invalid but unexpected: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L697)
    - [Standalone: person does not exist in PDL: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L704)
