...
- [should be able to dupliser (from dashboard) an existing sykmelding with correct values](./fhir/dashboard/dupliser.spec.ts#L32)
- [should be able to dupliser behandlingsdager (from dashboard) @feature-toggle](./fhir/dashboard/dupliser.spec.ts#L87)
- [should be able to dupliser (from dashboard) an existing sykmelding, go to summary, and return to form without losing values](./fhir/dashboard/dupliser.spec.ts#L129)
- [should not be possible to dupliser (from dashboard) old sykmelding](./fhir/dashboard/dupliser.spec.ts#L181)

## [fhir/dashboard/forleng.spec.ts](./fhir/dashboard/forleng.spec.ts)

- [should be able to forlenge an existing sykmelding with correct values](./fhir/dashboard/forleng.spec.ts#L32)
- [should be able to forlenge an existing behandlingsdager-sykmelding with correct values @feature-toggle](./fhir/dashboard/forleng.spec.ts#L81)
- [should be able to forleng a sykmelding, go to summary, and return to form without losing values](./fhir/dashboard/forleng.spec.ts#L130)
...
- [should pre-fill bidiagnoser from FHIR](./fhir/fhir-form-submit.spec.ts#L97)
    ...
    - [adding extra diagnose and resetting them should remove them](./fhir/fhir-form-submit.spec.ts#L139)
...
- [FHIR: simple - 100% sykmelding](./multi-mode/form-submit.spec.ts#L30)
- [FHIR: simple - gradert sykmelding](./multi-mode/form-submit.spec.ts#L60)
- [FHIR: optional - multiple bidiagnoser](./multi-mode/form-submit.spec.ts#L89)
- [FHIR: optional - multiple perioder back to back](./multi-mode/form-submit.spec.ts#L120)
- [FHIR: optional - "har flere arbeidsforhold" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L167)
- [FHIR: optional - when 100%, "arbeidsrelaterte og medisinske årsaker" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L198)
- [FHIR: summary - "skal skjermes" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L236)
- [Standalone: simple - 100% sykmelding](./multi-mode/form-submit.spec.ts#L30)
- [Standalone: simple - gradert sykmelding](./multi-mode/form-submit.spec.ts#L60)
- [Standalone: optional - multiple bidiagnoser](./multi-mode/form-submit.spec.ts#L89)
- [Standalone: optional - multiple perioder back to back](./multi-mode/form-submit.spec.ts#L120)
- [Standalone: optional - "har flere arbeidsforhold" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L167)
- [Standalone: optional - when 100%, "arbeidsrelaterte og medisinske årsaker" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L198)
- [Standalone: summary - "skal skjermes" should be part of payload if checked](./multi-mode/form-submit.spec.ts#L236)
    ## [FHIR: rule outcomes](./multi-mode/form-submit.spec.ts)
    - [FHIR: invalid but functionally expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L278)
    - [FHIR: manuell behandling and expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L306)
    - [FHIR: invalid but unexpected: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L334)
    - [FHIR: person does not exist in PDL: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L341)
    ## [Standalone: rule outcomes](./multi-mode/form-submit.spec.ts)
    - [Standalone: invalid but functionally expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L278)
    - [Standalone: manuell behandling and expected: should be able to submit læll](./multi-mode/form-submit.spec.ts#L306)
    - [Standalone: invalid but unexpected: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L334)
    - [Standalone: person does not exist in PDL: should NOT be able to submit](./multi-mode/form-submit.spec.ts#L341)

## [multi-mode/form-tilbakedatering.spec.ts](./multi-mode/form-tilbakedatering.spec.ts)

- [FHIR: 'tilbakedatering' should be removed from state when period is updated to not be a 'tilbakedatering' period](./multi-mode/form-tilbakedatering.spec.ts#L23)
- [FHIR: 'tilbakedatering' is asked and required when fom is 5 days in the past](./multi-mode/form-tilbakedatering.spec.ts#L59)
- [FHIR: "tilbakedatering" and "Annen årsak" input field is required and part of payload when checked](./multi-mode/form-tilbakedatering.spec.ts#L131)
- [Standalone: 'tilbakedatering' should be removed from state when period is updated to not be a 'tilbakedatering' period](./multi-mode/form-tilbakedatering.spec.ts#L23)
- [Standalone: 'tilbakedatering' is asked and required when fom is 5 days in the past](./multi-mode/form-tilbakedatering.spec.ts#L59)
- [Standalone: "tilbakedatering" and "Annen årsak" input field is required and part of payload when checked](./multi-mode/form-tilbakedatering.spec.ts#L131)

## [multi-mode/form-utdypende-sporsmal.spec.ts](./multi-mode/form-utdypende-sporsmal.spec.ts)

- [FHIR: Submit sykmelding with utdypende spørsmål when owning all sykmeldinger](./multi-mode/form-utdypende-sporsmal.spec.ts#L21)
- [FHIR: Submit sykmelding with utdypende spørsmål when sykmeldinger is redacted but SYK_INN_SHOW_REDACTED: true](./multi-mode/form-utdypende-sporsmal.spec.ts#L66)
- [FHIR: Submit sykmelding with utdypende spørsmål when sykmeldinger is redacted last one is owned by user](./multi-mode/form-utdypende-sporsmal.spec.ts#L114)
- [FHIR: Trigger all utdypende spørsmål in one 100% sykmelding](./multi-mode/form-utdypende-sporsmal.spec.ts#L145)
- [FHIR: Trigger week 17 when week 7 has already been answered](./multi-mode/form-utdypende-sporsmal.spec.ts#L195)
- [Standalone: Submit sykmelding with utdypende spørsmål when owning all sykmeldinger](./multi-mode/form-utdypende-sporsmal.spec.ts#L21)
- [Standalone: Submit sykmelding with utdypende spørsmål when sykmeldinger is redacted but SYK_INN_SHOW_REDACTED: true](./multi-mode/form-utdypende-sporsmal.spec.ts#L66)
- [Standalone: Submit sykmelding with utdypende spørsmål when sykmeldinger is redacted last one is owned by user](./multi-mode/form-utdypende-sporsmal.spec.ts#L114)
- [Standalone: Trigger all utdypende spørsmål in one 100% sykmelding](./multi-mode/form-utdypende-sporsmal.spec.ts#L145)
- [Standalone: Trigger week 17 when week 7 has already been answered](./multi-mode/form-utdypende-sporsmal.spec.ts#L195)
