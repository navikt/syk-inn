...
const createFullOpprettSykmeldingPayload = (
    ...
    values: {
        ...
        utdypendeSporsmal: {
            ...
            sykdomsutvikling: 'Forverring av tilstand',
            utfordringerHelsetilstand: 'Vanskelig å konsentrere seg',
            ...
            oppdatertMedisinskOppsummering: 'Oppdatert medisinsk oppsummering',
            mestringArbeidshverdag: 'Mestring av arbeidshverdag',
