...
describe('filterSykmeldingerWithinDaysGap', () => {
    ...
    test('should sort by latest tom desc', () => {
        const sykmelding1 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2023-01-01', tom: '2023-01-05' })
            .build()
        const sykmelding2 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2023-01-06', tom: '2023-01-10' })
            .build()
    ...
    test('should filter out sykmeldinger with ISYFO_DAYS_GAP of 16 days or more', () => {
        const sykmelding1 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2025-01-01', tom: '2025-01-10' })
            .build()
        const sykmelding2 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2025-01-24', tom: '2025-02-01' })
            .build()
        const sykmelding3 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2025-02-17', tom: '2025-02-31' })
            .build()
    ...
    test('should only return the newest period with continious sykfraver', () => {
        const sykmelding1 = new SykmeldingBuilder()
            ...
            .build()
        const sykmelding2 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2025-01-11', tom: '2025-01-20' })
            .build()
        const sykmelding3 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2024-01-01', tom: '2024-01-10' })
            .build()
        const sykmelding4 = new SykmeldingBuilder()
            .aktivitetIkkeMulig({ type: 'AKTIVITET_IKKE_MULIG', fom: '2024-01-11', tom: '2024-01-20' })
            .build()
