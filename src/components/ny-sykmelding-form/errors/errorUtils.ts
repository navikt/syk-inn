...
type TraversableTree = FieldError | FieldErrors<NySykmeldingFormValues>
...
type FieldErrorTuple = [key: string, value: FieldError | FieldErrors<NySykmeldingFormValues> | undefined] | undefined
