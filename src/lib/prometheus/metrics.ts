...
class AppMetrics {
    ...
    public diagnoseCounter = new Counter({
        name: 'syk_inn_number_of_diagnoser_total',
        help: 'Counter of number of diagnoses submitted in sykmeldinger',
        labelNames: ['system', 'code', 'type', 'source'] as const,
    })
}
